...
@Component({
    selector: 'phieutra-view',
    templateUrl: 'PhieuTraView.html',
    styleUrls: ['../../phieumuon/view/PhieuMuonView.css'],
})
export default class PhieuTraView implements OnInit {
    constructor(
    ...
    navigateToEdit(id: any) {
        this.route.navigateByUrl('/admin/phieutra/detail/' + id);
    }
}
